...
TARGETS_STD = [
    "Inertia Tensor/Area XX_Std",
    "Inertia Tensor/Area XY_Std",
    "Inertia Tensor/Area YY_Std",
]

TARGETS_MEDIAN = [
    "Inertia Tensor/Area XX_Median",
    "Inertia Tensor/Area XY_Median",
    "Inertia Tensor/Area YY_Median",
]

TARGETS_Q1 = [
    "Inertia Tensor/Area XX_Q1",
    "Inertia Tensor/Area XY_Q1",
    "Inertia Tensor/Area YY_Q1",
]

TARGETS_Q3 = [
    "Inertia Tensor/Area XX_Q3",
    "Inertia Tensor/Area XY_Q3",
    "Inertia Tensor/Area YY_Q3",
]
...
STD_VALUES = {
    "Inertia Tensor/Area XX_Std": 0.0147,
    "Inertia Tensor/Area XY_Std": 0.0157,
    "Inertia Tensor/Area YY_Std": 0.0151,
}

MEDIAN_VALUES = {
    "Inertia Tensor/Area XX_Median": 0.0829,
    "Inertia Tensor/Area XY_Median": -0.0012,
    "Inertia Tensor/Area YY_Median": 0.0827,
}

Q1_VALUES = {
    "Inertia Tensor/Area XX_Q1": 0.0747,
    "Inertia Tensor/Area XY_Q1": -0.0093,
    "Inertia Tensor/Area YY_Q1": 0.0759,
}

Q3_VALUES = {
    "Inertia Tensor/Area XX_Q3": 0.0952,
    "Inertia Tensor/Area XY_Q3": 0.0083,
    "Inertia Tensor/Area YY_Q3": 0.0923,
}
...
def plot_optimization(csv_path, output_dir, x0=None):
    ...
    output_filename = os.path.join(output_dir, f"plot_line({file_name}).tiff")

    # Завантаження даних
    df = pd.read_csv(csv_path)

    # Список стовпців з картинки
    columns_to_keep = [
        "wave_coefficient",
        "concentration",
        "halfaxis_a",
    ...
    # Фільтрація: залишаємо тільки їх
...
def main():
    # csv_path = r"D:\Project(MatViz3D)\Random\Paper_Optimisation\test\iter\halfaxis_a_Std\run_parameters_and_selected_features.csv"
    # output_dir = r"D:\Project(MatViz3D)\Random\Paper_Optimisation\test\iter\halfaxis_a_Std\plot_line_minimize"
    x0 = [0.1, 1, 1.5, 1.5, 1.5, 90, 90, 90]
    # plot_inertia_dependencies(csv_path, output_dir)

    csv_path = r"D:\Project(MatViz3D)\Random\Paper_Optimisation\Zp_paper_result\Result\AZ31_iA\Dual_Annealing\SMAPE\run_parameters_and_selected_features.csv"
    output_dir = r"./test/"
